#!/usr/bin/env python3
"""
Task 01: Reorder classifier.

This is a thin runner around local_train_mllib.py, the canonical Colab/local
implementation. Keeping the task scripts as wrappers prevents result drift
between notebooks, Docker, and teammates' machines.
"""
...
DEFAULT_OUTPUT_DIR = PROJECT_DIR / "local_outputs" / "01_reorder_classifier_seed42"
